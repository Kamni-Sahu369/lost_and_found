...
const MatchItems = () => {
  ...
  const columns = [
    ...
    { title: 'Match Score', dataIndex: 'match', key: 'match' },
    ...
    <div className="match-items-container">
      ...
      >
        {selectedItem && (
          <ul>
            ...
            <li><strong>Match Score:</strong> {selectedItem.match}</li>
      ...
      >
        <Form form={form} layout="vertical">
          ...
          <Form.Item name="match" label="Match Score" rules={[{ required: true }]}>
            <Input />
          </Form.Item>
