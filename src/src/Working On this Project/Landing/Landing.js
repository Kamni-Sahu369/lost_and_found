...
import Approval from "../Admin/Pages/Request/Approval/Approval";
...
import UserApproval from "../User/Pages/Request/Approval/Approval";
            ...
            <Routes>
              {role === "admin" ? (
                <>
                  ...
                  <Route path="/request/approval" element={<Approval />} />
                  ...
                  <Route path="/Monthly_report" element={<Montly_report />} />
                ...
                <>
                  ...
                  <Route path="/request/approval" element={<UserApproval />} />
