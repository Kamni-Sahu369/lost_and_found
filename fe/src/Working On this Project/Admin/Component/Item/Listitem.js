...
// import { Lost_get, Found_get } from '../../../Api/Service.js';  // adjust path
// import './Listitem.css'; // external CSS
...
//     try {
//       const [lostDataRaw, foundDataRaw] = await Promise.all([
//         Lost_get(),
//         Found_get(),
//       ]);
...
// import React, { useEffect, useState } from 'react';
// import { Table, Input, Space, Tag, Modal } from 'antd';
...
//       if (record.status) {
//         // Found item
//         response = await Found_get(record.id);
//       } else {
//         // Lost item
//         response = await Lost_get(record.id);
//       }

//       setSelectedImage(response.item_image);
//       setIsModalVisible(true);
//     } catch (error) {
